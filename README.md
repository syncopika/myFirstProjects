...
good tutorial here:  http://www.williammalone.com/articles/create-html5-canvas-javascript-drawing-app/
  
try/see it here: http://syncopika.tumblr.com/htmldrawapp  

4. a simple graphing app
------------------------
made with HTML, CSS(bootstrap), jQuery/javascript 

the one here is just a sketch of some components I needed, mainly the part to calculate the equation input by the user. right now the most current version can handle simple quadratic and cubic functions, and only positive constants and coefficients. (as of 08/06/16, not true anymore. it's better! ^_^)
  
try/see it here: http://syncopika.tumblr.com/simplegraphing
